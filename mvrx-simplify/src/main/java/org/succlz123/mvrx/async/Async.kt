package org.succlz123.mvrx.async
...
data class DataNone(val errorMessage: String? = null) : Async<Nothing>(complete = true, shouldLoad = true, value = null)

data class DataError<out T>(val errorMessage: String? = null, private val value: T? = null) : Async<T>(complete = true, shouldLoad = true, value = value)
